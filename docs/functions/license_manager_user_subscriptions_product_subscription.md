...
```text
license_manager_user_subscriptions_product_subscription(product_subscription_id string, options map of string...) string
```

## Arguments

<!-- arguments generated by tfplugindocs -->
1. `product_subscription_id` (String) Value for `${ProductSubscriptionId}` in the ARN template.
